...
<html lang="en">
	...
	<body>
		...
		<section>
			<div class="hero-text">
			<h4 class="hero-view-feedback">Select Modify Service</h4>
			</div>
		</section>
		<section>
			<h1>Select Modification Services</h1>
<%! int count=0; %>
<%ArrayList<Service> modifications =(ArrayList)request.getAttribute("modifications");%>
          ...
          <tr>
           ...
           <td><%= ++count %></td>
              <td><%=s.getServiceno() %></td>
               ...
               <%--  <td><a href="Updateservice?id="+<%=s.getServiceno()%> >update</a></td>  --%> 
                <td> <a href=<%= "\"Updateservice?Id=" + s.getServiceno() + "\"" %> >update</a>      
          </tr>
          <%}%>
         </tbody>
      </table><br>
